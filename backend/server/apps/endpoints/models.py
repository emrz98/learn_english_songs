...
class MLAlgorithm(models.Model):
    ...
    Attributes:
        ...
        description: The short description of how the algoritm works.
        code: The code of the algorithm
        version: The version of the algoritm similar to software versioning.
        owner: The name of the owner.
        created_at: The date when MLAlgoritm was added
